...
// stereo_displace_b : same as stereo_displace but with 3-tap depth blur
// to reduce aliasing at depth discontinuities. A/B test version.
//
...
void main(void) {
    ...
    // 3-tap depth blur to smooth aliasing at depth edges
    float px = 1.0 / tres.x;
    ...
    // Compute depth per tap (luma only — avoids hue function overhead)
